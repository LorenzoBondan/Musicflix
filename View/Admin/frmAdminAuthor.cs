...
{
    public partial class frmAdminAuthor : Form
    {
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                authorDTO.id = (int)dataGridView1.SelectedRows[0].Cells[0].Value;
                authorDTO.name = txtName.Text;
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                txtBirthDate.Text = selectedRow.Cells[2].Value.ToString();
